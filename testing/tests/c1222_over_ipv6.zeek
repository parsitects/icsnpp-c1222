...
#
# @TEST-EXEC: zeek -C -r ${TRACES}/c1222_std_example8.pcap ${PACKAGE} %INPUT C1222::log_authentication_value=T C1222::log_identification_service=T C1222::log_read_write_service=T C1222::log_logon_service=T C1222::log_dereg_reg_service=T C1222::log_resolve_service=T C1222::log_trace_service=T
#
...
#
# @TEST-DOC: Test rocplus analyzer with c1222_std_example8.pcap